...
namespace CRTFilter
{
    public class CRTRendererFeature : ScriptableRendererFeature
    {
        ...
        [Range(0f, 30f)]
        public float scanlinesRange = 1;
        [Range(0f, 30f)]
        public float scanlinesColorGlitchA = 1;
        [Range(0f, 30f)]
        public float scanlinesColorGlitchB = 1;
        [Range(0f, 10f)]
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            material.SetFloat("m_scanlinesRange", scanlinesRange);
            material.SetFloat("m_scanlinesColorGlitchA", scanlinesColorGlitchA);
            material.SetFloat("m_scanlinesColorGlitchB", scanlinesColorGlitchB);
